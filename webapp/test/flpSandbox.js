		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#comapphubyshipment-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comapphubyshipment-display": {
								"semanticObject": "comapphubyshipment",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.app.hubyshipment",
									"url": sap.ui.require.toUrl("com/app/hubyshipment")
								}
							}
						}
					}
